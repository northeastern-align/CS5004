/**
 * This class represents the AnimatedRectangle animated shape type. This extends from the abstract
 ...
 * also contains a toString method to print out the associated information with the rectangle,
 * including corner location, width/height, color, and times.
 */
public class AnimatedRectangle extends AAnimatedShape {
   ...
   */
  public AnimatedRectangle(IShape shape, int t1, int t2) {
    super(shape, t1, t2);
  }
   ...
   *
   * @return a string value that includes the shape type, corner location, width/height, color (RGB
