...
public class ModelTest {
  ...
  public void rectangleResize2() {
    ...
    assertEquals("Shapes:\n"
                    ...
                    + "Appears at t=0\n"
                    + "Disappears at t=100\n\n"
                    + "Shape Rectangle4 changes color from (100, 100, 100) to (20, 20, 20) " +
                    "from t=0 to t=99\n"
                    + "Shape Rectangle4 scales from (20, 10) to (20, 20) from t=0 to t=100\n",
            model.getState());
  }
  ...
  public void rectangleChangeColor1() {
    model.addShape("Rectangle5", ShapeType.RECTANGLE, 0, 21, 5, 5, 20, 10, 100, 100, 100);
    ...
    assertEquals("Shapes:\n"
                    ...
                    + "Appears at t=0\n"
                    + "Disappears at t=21\n\n"
                    + "Shape Rectangle5 changes color from (100, 100, 100) to (20, 20, 20) " +
                    "from t=20 to t=21\n",
            model.getState());
  }
  ...
  public void rectangleMoves() {
    model.addShape("Rectangle6", ShapeType.RECTANGLE, 0, 77, 5, 5, 20, 10, 100, 100, 100);
    model.addMoveMotion("Rectangle6", 0, 20, 20, 20);
