/**
 * This class represents the chess piece Queen that extends the AbstractPiece class. This piece is
...
public class Queen extends AbstractPiece {
  ...
  /**
   * Construct a Queen object that is passed a row, column, and piece color.
   *
  ...
  /**
   * Returns a boolean value if a Queen can legally move to a target (row, column).
   *
  ...
  public boolean canMove(int row, int column) {
    ...
    return (((this.row == row && this.column != column) ||
        ...
        (Math.abs(this.column - column) == Math.abs(this.row - row)));
  }

  /**
   * Returns a boolean value if a Queen can legally move and kill a target (row, column).
   *
  ...
  public boolean canKill(AbstractPiece piece) {
    ...
    if (this.color != piece.getColor()) {
      ...
      return (((this.row == piece.getRow() && this.column != piece.getColumn()) ||
          (this.row != piece.getRow() && this.column == piece.getColumn())) ||
          (Math.abs(this.column - piece.getColumn()) == Math.abs(this.row - piece.getRow())));
    }
